...
function isOnGame(left,top){
    if(parseInt(window.getComputedStyle(machine).getPropertyValue("left")) + left <= 385 &&
       parseInt(window.getComputedStyle(machine).getPropertyValue("top")) + top <= 475 &&
